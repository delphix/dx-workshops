output "delphix-centos7-postgres11-source_ip" {
  value = module.delphix_source.public_ip
}

output "delphix-centos7-postgres11-source_image" {
  value = module.delphix_source.instance_id
}

output "delphix-centos7-postgres11-target_ip" {
  value = module.delphix_target.public_ip
}

output "delphix-centos7-postgres11-target_image" {
  value = module.delphix_target.instance_id
}

output "delphix-tcw-tooling-postgres11_ip" {
...
output "delphix-centos7-postgres11-source_system" {
  value = module.delphix_source.instance_id
}

output "delphix-centos7-postgres11-target_system" {
  value = module.delphix_target.instance_id
}
