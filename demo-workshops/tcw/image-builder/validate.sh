...
function HELP() {
    echo -e "\nPlease visit https://github.com/delphix/packer-templates/blob/master/demo-workshops/tcw/docs/building.md to validate the pre-requisites."
    exit 1
}
